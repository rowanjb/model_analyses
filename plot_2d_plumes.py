...
if __name__ == "__main__":
    ...
    run_plot_vertical_plane(run='mrb_035', var='quiver', vmin=0, vmax=0.2)
    run_plot_vertical_plane(run='mrb_035', var='T', vmin=-2, vmax=2)
    run_plot_vertical_plane(run='mrb_035', var='S', vmin=34.4, vmax=34.9)
    run_plot_vertical_plane(run='mrb_035', var='rho_theta', vmin=27.7, vmax=27.85,eos='TEOS10')
